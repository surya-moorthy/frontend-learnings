        ...
        <div className="hero-section flex flex-col justify-center items-center m-auto mt-10 max-w-2xl">
            ...
            <div className="m-10 space-y-4">
                ...
                <div className="flex items-center justify-center gap-0 hover:gap-1 transition-all duration-250">
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-arrow-right-icon lucide-arrow-right text-orange-500"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                </div>
            </div>
        </div>
    )
