...
export default function Sliding() {
  return (
    <div className="overflow-hidden w-full mb-10">
         <div className="absolute left-0 top-0 w-2xl h-full z-10 pointer-events-none bg-gradient-to-r from-neutral-50 to-transparent" />
         <div className="absolute right-0 top-0 w-2xl h-full z-10 pointer-events-none bg-gradient-to-l border-none from-neutral-50 to-transparent" />
